...
Proof.
  ...
  intros. simpl in H. bdall. discriminate.
Qed.
...
Proof.
  ...
  - simpl. apply in_app_iff. simpl. inv H. inv H0.
    ...
    apply Nat.le_antisymm in H0. rewrite H0. reflexivity.
    apply H.
Qed.
...
Lemma elements_tr_helper :
  forall (V : Type) (t : tree V) (lst : list (key * V)),
    elements_aux t lst = elements t ++ lst.
Proof.
...
Proof.
  intros. unfold elements_tr. rewrite elements_tr_helper. 
...
Corollary elements_tr_correct :
  forall (V : Type) (k : key) (v d : V) (t : tree V),
    ...
    bound k t = true /\ lookup d k t = v.
Proof.
  intros. rewrite elements_tr_elements in H0.
